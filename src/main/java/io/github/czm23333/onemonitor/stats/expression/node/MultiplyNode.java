    ...
    public Object execute(Map<String, Object> env) {
        ...
        switch (lop) {
            ...
            case List<?> l && rop instanceof List<?> r:
                if (l.size() != r.size())
                    throw new IllegalExpressionException("Tried multiplying two lists with different length");
                ...
                return result;
            default:
                throw new IllegalExpressionException("Tried multiplying non-double values");
        }
    }
